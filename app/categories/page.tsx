      ...
      <div className="space-y-5">
        <div className="pb-3 border-b border-[#e6e6e1]">
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            Daftar kategori resmi untuk klasifikasi otomatis pengeluaran
          </p>
        </div>
        ...
        <Card className="p-8 sm:p-12 text-center border-dashed">
          ...
          <h3 className="text-sm font-bold text-zinc-900">Kategori Master Pengeluaran</h3>
          <p className="text-xs text-zinc-500 max-w-md mx-auto mt-1 mb-4 leading-relaxed">
            API kategori master dan pencocokan kata kunci telah aktif di database. Halaman konfigurasi master akan dirilis pada fase admin.
          </p>
