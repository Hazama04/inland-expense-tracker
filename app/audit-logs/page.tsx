      ...
      <div className="space-y-5">
        <div className="pb-3 border-b border-[#e6e6e1]">
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            Log jejak audit perubahan data transaksi yang bersifat immutable (hanya baca)
          </p>
        </div>
        ...
        <Card className="p-8 sm:p-12 text-center border-dashed">
          ...
          <h3 className="text-sm font-bold text-zinc-900">Audit Trail Immutable</h3>
          <p className="text-xs text-zinc-500 max-w-md mx-auto mt-1 mb-4 leading-relaxed">
            Seluruh mutasi status, input manual, dan koreksi transaksi otomatis dicatat pada tabel audit log secara transaksional.
          </p>
